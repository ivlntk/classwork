 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "                              \"Avg Total Purchase per Person\": purchNorm})\n",
    "\n",
    "# DataFrame formatting\n",
    ...
    "Purch_Anal_Gen[\"Avg Total Purchase per Person\"] = Purch_Anal_Gen[\"Avg Total Purchase per Person\"].map(\"${:.2f}\".format)\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\ivlnt\\Anaconda3\\lib\\site-packages\\ipykernel_launcher.py:19: SettingWithCopyWarning: \n",
